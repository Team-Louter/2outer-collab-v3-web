    ...
    return(
        <>
            <nav className="side_bar">
                <div id="minus_div">
                    <svg id="minus_img" className="icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5 12C5 11.7348 5.10536 11.4804 5.29289 11.2929C5.48043 11.1054 5.73478 11 6 11H18C18.2652 11 18.5196 11.1054 18.7071 11.2929C18.8946 11.4804 19 11.7348 19 12C19 12.2652 18.8946 12.5196 18.7071 12.7071C18.5196 12.8946 18.2652 13 18 13H6C5.73478 13 5.48043 12.8946 5.29289 12.7071C5.10536 12.5196 5 12.2652 5 12Z" fill="#181F29"/>
                    </svg>
                </div>

                <div id="plus_div" className="button_hover">
                    <svg id="plus_img" className="icon" width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="plus_text" id="plus_text">새 프로젝트 만들기</div>
                </div>

                <div className="line"></div>

                <div className="project_text" id="project_text">내 프로젝트</div>
                
                <div className="my_project">
                    <ul className="project_list">
                        <li className="project_item">
                            <div className="project_gradation">
                                <div className="project_white">
                                    <img className="project_icon" src="../src/assets/images/project_img/Louter.svg" alt="프로젝트 이미지"/>
                                </div>
                            </div>
                            <div className="project_info">
                                <div className="project_name">Louter</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            <div className="project_gradation">
                                <div className="project_white">
                                    <img className="project_icon" src="../src/assets/images/project_img/B1ND.svg" alt="프로젝트 이미지"/>
                                </div>
                            </div>
                            <div className="project_info">
                                <div className="project_name">B1ND</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            <div className="project_gradation">
                                <div className="project_white">
                                    <img className="project_icon" src="../src/assets/images/project_img/CNS.svg" alt="프로젝트 이미지"/>
                                </div>
                            </div>
                            <div className="project_info">
                                <div className="project_name">CNS</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            <div className="project_gradation">
                                <div className="project_white">
                                    <img className="project_icon" src="../src/assets/images/project_img/3D.svg" alt="프로젝트 이미지"/>
                                </div>
                            </div>
                            <div className="project_info">
                                <div className="project_name">삼디</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            <div className="project_gradation">
                                <div className="project_white">
                                    <img className="project_icon" src="../src/assets/images/project_img/두카미.svg" alt="프로젝트 이미지"/>
                                </div>
                            </div>
                            <div className="project_info">
                                <div className="project_name">두카미</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            <div className="project_gradation">
                                <div className="project_white">
                                    <img className="project_icon" src="../src/assets/images/project_img/ALT.svg" alt="프로젝트 이미지"/>
                                </div>
                            </div>
                            <div className="project_info">
                                <div className="project_name">ALT</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            <div className="project_gradation">
                                <div className="project_white">
                                    <img className="project_icon" src="../src/assets/images/project_img/모디.svg" alt="프로젝트 이미지"/>
                                </div>
                            </div>
                            <div className="project_info">
                                <div className="project_name">모디</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            <div className="project_gradation">
                                <div className="project_white">
                                    <img className="project_icon" src="../src/assets/images/project_img/CHATTY.svg" alt="프로젝트 이미지"/>
                                </div>
                            </div>
                            <div className="project_info">
                                <div className="project_name">CHATTY</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            ...
                            <div className="project_info">
                                <div className="project_name">Louter2</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            ...
                            <div className="project_info">
                                <div className="project_name">Louter3</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                        <li className="project_item">
                            ...
                            <div className="project_info">
                                <div className="project_name">Louter4</div>
                                <div className="project_owner">hyxx._.su</div>
                            </div>
                        </li>
                    </ul>
                ...
                <div className="setting button_hover">
                ...
                <div className="darkmode button_hover">
                ...
                <div className="rule1 button_hover">서비스 운영 정책</div>
                
                <div className="rule2 button_hover">개인정보 처리 방침</div>
                
                <div className="logout button_hover">
