            ...
            <div className="top-container">
              <div className="top-container-wrapper">
                <div className="top-container-wrapper-left">
                  ...
                  <div className="top-container-title">공지사항</div>
                </div>
                ...
                {notices.map((notice) => {
                  ...
                  return (
                    <div key={notice.id} className="notice-item">
                      {/* 공지 박스 */}
                      <div
                        className={`notice-box ${isOpen ? "open" : ""}`}
                      ...
                      >
                        ...
                        <div className="notice-box-right">
                          ...
                          <p>·</p>
                          <div className="notice-user">{notice.user}</div>
                        </div>
                      </div>

                      {/* 펼쳐지는 상세내용 */}
                      <div className={`notice-detail ${isOpen ? "open" : ""}`}>
                        {notice.detail}
                      </div>
                    </div>
                  );
            ...
            <div className="modal" onClick={(e) => e.stopPropagation()}>
              <div className="modal-top">
                <div className="modal-top-wrapper">
                  <div className="modal-title">공지 생성</div>
                </div>
              </div>
              <div className="modal-middle">
                <div className="modal-middle-title">
                  <div className="modal-middle-title-top">
                    <div className="notice-title-box-title">제목</div>
                  ...
                  <div className="modal-middle-title-bottom">
                    <div className="notice-title-length">0/50</div>
                  </div>
                  <div className="modal-bottom-des-top">
                    <div className="notice-des-box-title">내용</div>
                    <div className="star">*</div>
                  </div>
                  <div className="modal-bottom-des-middle">
                    <textarea
                      className="notice-des-input"
                      placeholder="제목을 입력하세요."
                    ></textarea>
                  </div>
                  <div className="modal-bottom-des-bottom">
                    <div className="notice-des-length">0/250</div>
                  </div>
                </div>
                <div className="modal-bottom-title"></div>
              </div>
